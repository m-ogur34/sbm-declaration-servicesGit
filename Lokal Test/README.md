...
| Dosya | Ne işe yarar |
|---|---|
| `bruno-lokal-test-2025-01.json` | Bruno koleksiyonu — 8 klasör, 29 istek, sırayla çalıştırılır |
| `test-lokal-2025-01.xlsx` | 12 satır / 6 beyanname (`TESTDEV2501-01..06`), dönem **2025/01** |
| `test-lokal-2025-01-guncelleme.xlsx` | Aynı dönem: `-01` ve `-03` tutarları değişmiş, `-07` yeni — upsert ve PUT testi |
...
2. Bruno → **Import Collection → Bruno Collection** → `bruno-lokal-test-2025-01.json`.
